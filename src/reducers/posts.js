export default (posts = [], action) => {
   switch (action.type) {
      ...
      //put two cases one below each other and they will both do the same thing so since both update and like are doing similar process the just add both cases
      case 'UPDATE':
      case 'LIKE':
